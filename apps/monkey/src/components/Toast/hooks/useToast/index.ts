...
import type { UseToastHookReturn, UseToastInstance, UseToastOptions } from '@/components/Toast/hooks/useToast/types'
import type { ToastProps } from '@/components/Toast/Toast/types'
import { useToastContainer } from '@/components/Toast/Container/provide'
...
/** 创建 Toast 实例 */
function createToastInstance(container: ToastContainerContext, id: string, options: UseToastOptions): UseToastInstance {
