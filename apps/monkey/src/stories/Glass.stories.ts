...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          '统一 Glass 材质体系：调用层只选择 surface、inset、floating、overlay 或 panel 场景，边框、高光、阴影和模糊由同一组材质变量生成。',
      },
    },
  },
  tags: ['autodocs'],
    ...
    template: `
      <div class="app-bg-mesh grid gap-6 rounded-3xl p-8 xl:grid-cols-2">
        <section class="app-glass-panel rounded-3xl p-6">
          <p class="text-base-content/60 mb-4 text-sm">Panel：侧栏、抽屉和大型弹层</p>
          <div class="app-glass-surface rounded-2xl p-4">
            <p class="text-base-content/60 mb-3 text-xs">Surface：面板内部弱层次</p>
        ...
        <section class="flex flex-col gap-6">
          <div>
            <p class="text-base-content/60 mb-3 text-sm">Floating + Inset：悬浮控制组与内部选中项</p>
          ...
          <div class="bg-neutral rounded-3xl p-6">
            <p class="text-neutral-content/70 mb-3 text-sm">Overlay：图片或视频上方</p>
