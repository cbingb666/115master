...
/** 下载 */
export type FilesDownload = ApiResponseBase<{
  file_url: string
}>

/** 视频文件信息 */
export type FilesVideo = ApiResponseBase<{
  /** 是否开启内嵌字幕 */
  inlay_power: number
  /** 是否开启视频推送 */
...
/** Pro 下载响应 */
export type FilesAppChromeDownurl = ApiResponseBase<{
  url: string
  data: string
}>

/** m3u8 响应 */
export type VideoM3u8 = ApiResponseBase<{ data: string }>
